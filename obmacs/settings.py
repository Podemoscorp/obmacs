"""
Django settings for obmacs project.
...
SECRET_KEY = (
    ...
    or "django-insecure-w+u9tkiq46_ctz-ic_eha^h1j@lluxkw-0j)p3y31a5cc&ygul"
)
...
WSGI_APPLICATION = "obmacs.wsgi.application"
...
django_heroku.settings(locals())  # Configuraçãos do herok
